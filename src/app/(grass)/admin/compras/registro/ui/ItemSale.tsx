...
export const ItemSale = ({ saleProduct, removeItem, quantityItem }: Props) => {
    ...
    return (
        <>
            <div className="flex flex-col md:flex-row justify-between items-center mb-4 mt-2">
                ...
                <Quantity quantity={saleProduct.quantity} onQuantityChange={quantityItem} stock={0} />
                <div className="mb-1 mt-2 md:mt-0 md:mb-0 ml-0 md:ml-1.5  font-semibold text-lg  w-fit text-center">
                    {currencyFormat(saleProduct.purchasePrice * saleProduct.quantity)}
                </div>
                <button
                    onClick={() => removeItem()}
