...
import { ViewDetailA } from './ui/ViewDetailA';
...
export default async function GrassPage({ params }: Props) {
  ...
  const { status, cashStatus, rentals, total } = await getRental({ id })
  ...
  return (
    <div className="bg-white p-8 rounded-md w-full">
      ...
      <div className="relative flex flex-col w-full h-full overflow-scroll text-gray-700 bg-white shadow-md rounded-lg bg-clip-border">
              ...
              rentals.map(rental => (
                <tr key={rental.id} className="hover:bg-slate-50 border-b border-slate-200">
                  ...
                  <td className="p-4 py-5 text-center">
                    <ViewDetailA description={rental.description || '-'} />
                  </td>
                </tr>
              ))
            }
        ...
        <div className="flex items-center my-5 mt-20 mb-20">
